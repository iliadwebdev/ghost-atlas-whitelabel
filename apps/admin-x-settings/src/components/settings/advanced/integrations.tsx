...
const IntegrationItem: React.FC<IntegrationItemProps> = ({
    ...
    return <ListItem
        ...
        testId={testId}
        title={active ? <span className='inline-flex items-center gap-1'>{title} <span className='inline-flex items-center rounded-full bg-[rgba(73,69,255,0.15)] px-1.5 py-0.5 text-2xs font-semibold tracking-wide text-green uppercase'>Active</span></span> : title}
        onClick={handleClick}
    />;
};
