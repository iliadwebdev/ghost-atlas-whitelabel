            ...
            <div className="flex flex-col gap-4 pb-7 text-sm">
                    ...
                    {showSystemInfo() &&
                        showDatabaseWarning(
                            ...
                            <div className="text-red-500 dark:text-red-400">
                                You are running an unsupported database in
                                production. Please{" "}
                                <a
                ...
                <div className="flex flex-col gap-1.5">
                    <a
                        ...
                        target="_blank"
                    >
                        <Icon name="book-open" size="sm" /> User documentation
                    </a>
                    <a
                        className="flex items-center gap-2 hover:text-grey-900 dark:hover:text-grey-400"
                        ...
                        target="_blank"
                    >
                        <Icon name="question-circle" size="sm" /> Get help with
                        Ghost
                    </a>
                    <a
                        className="flex items-center gap-2 hover:text-grey-900 dark:hover:text-grey-400"
                        ...
                        target="_blank"
                    >
                        <Icon name="angle-brackets" size="sm" /> Get involved
                    </a>
                </div>
                <Separator />
                <p className="max-w-[460px] text-xs">
                    This is a modified installation of Ghost, built by{" "}
                    <a
                        href="https://www.iliad.dev/"
                    ...
                    . For support, please contact Iliad directly.
                </p>
                <Separator />
                <p className="max-w-[460px] text-xs">
                    Copyright © 2013 &ndash; {copyrightYear()} Ghost Foundation,
                    released under the{" "}
                    <a
                        className="text-green"
