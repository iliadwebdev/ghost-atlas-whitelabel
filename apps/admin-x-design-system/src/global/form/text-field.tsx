...
const TextField: React.FC<TextFieldProps> = ({
    ...
    const bgClasses = !unstyled && clsx(
        'absolute inset-0 rounded-lg border text-grey-300 transition-colors peer-hover:bg-grey-100 peer-focus:border-green peer-focus:bg-white peer-focus:shadow-[0_0_0_2px_rgba(73,69,255,.25)] dark:peer-hover:bg-grey-925 dark:peer-focus:bg-grey-950',
