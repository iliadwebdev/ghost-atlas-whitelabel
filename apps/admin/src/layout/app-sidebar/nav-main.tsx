                    ...
                    {!disableWebsiteFeatures && (
                        <NavMenuItem className="group/viewsite relative">
                            ...
                            <a
                                ...
                                className="hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute right-0 top-0 flex size-8 items-center justify-center rounded-full text-gray-700 opacity-0 transition-all group-hover/viewsite:opacity-100">
