            ...
            <div className="flex flex-col items-stretch gap-6">
                <div className="flex items-center justify-between">
                    <div className="flex min-w-0 items-center gap-3">
                        ...
                        <div className="text-foreground flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-[15px] font-semibold">
                            {title}
                        </div>
                    </div>
                </div>
                {showSearch && (
                    <Button
                        variant="outline"
                        className="text-muted-foreground shadow-xs hover:bg-background flex h-[38px] items-center justify-between pr-2 text-base hover:border-gray-200 hover:text-gray-700 hover:shadow-sm dark:bg-gray-950 dark:hover:border-gray-800 [&_svg]:stroke-2"
