    ...
    return (
        <Banner variant='gradient' size='lg' className="mx-2 flex flex-col items-stretch">
            ...
            <div className="mb-4 mt-2 text-sm text-gray-700">
                Choose a plan to access the full power of Ghost right away, you have <span className="text-foreground font-semibold">{trialDaysRemaining} days</span> free trial remaining.
            </div>
