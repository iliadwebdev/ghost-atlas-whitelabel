    ...
    return (
        <NavMenuItem>
            <Button
                ...
                variant="ghost"
                size="icon"
                className="hover:text-gray-black h-[34px]! text-sidebar-accent-foreground sidebar:opacity-0 absolute left-3 top-0 w-auto p-0 transition-all hover:bg-transparent focus-visible:opacity-100 group-hover/menu-item:opacity-100"
