    ...
    return (
        <>
            <NavMenuItem.Link
                ...
                isActive={isActive}
            >
                <LucideIcon.PenLine className="sidebar:opacity-100 sidebar:group-hover/menu-item:opacity-0 pointer-events-none opacity-0 transition-all" />
                <NavMenuItem.Label>Posts</NavMenuItem.Label>
            </NavMenuItem.Link>
            <a href="#/editor/post"
                aria-label="Create new post"
                className="hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute right-0 top-0 flex size-8 items-center justify-center rounded-full p-0 text-gray-700 transition-all"
            >
                <LucideIcon.Plus
                    size={20}
    ...
    return (
        <>
            <NavMenuItem.Link
                ...
                isActive={isActive}
            >
                <LucideIcon.Users className={collapsible ? "sidebar:opacity-100 sidebar:group-hover/menu-item:opacity-0 pointer-events-none opacity-0 transition-all" : ""} />
